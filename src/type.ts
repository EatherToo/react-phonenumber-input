...
export type BasePhoneNumberInputProps = ReactPhonenumberInputProps & {
  ...
  CallingCodeComponent: React.ComponentType<PhoneNumberCallingCodeProps>
  InputComponent: React.ComponentType<PhoneNumberInputElementProps>
  WrapperComponent: React.ComponentType<PhoneNumberInputWrapperProps>
}
...
export const allCountries: readonly CountryCode[] = Object.freeze([
  'AC',
  'AD',
  'AE',
  'AF',
